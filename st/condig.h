...
static const char *colorname[] = {
  ...
  /* keep these two indexes — stock st uses them for cursor/rev-cursor */
  "#e5e5e5", /* 256: cursor color */
  "#0f0f10", /* 257: reverse cursor color */
};

/* Default colors (colorname index)
 * foreground, background, cursor, reverse cursor
 */
unsigned int defaultfg = 7;     /* -> "#e5e5e5" */
unsigned int defaultbg = 0;     /* -> "#0f0f10" */
unsigned int defaultcs = 256;   /* cursor -> "#e5e5e5" */
static unsigned int defaultrcs = 257; /* rev-cursor -> "#0f0f10" */
